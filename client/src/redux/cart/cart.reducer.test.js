...
describe('cartReducer', () => {
  ...
  it('should decrease quantity of matching item by 1 if decreaseItemsCount action fired with same item as payload', () => {
    const mockItem = {
      id: 1,
      quantity: 3,
    };
  ...
  it('should delete item from cart if deleteCart action fired with payload of existing item', () => {
    const mockItem = {
      id: 1,
      quantity: 3,
    };
